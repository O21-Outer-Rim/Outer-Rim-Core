...
namespace OuterRimCore
{
	...
	public static class ListingStandardUtil
	{
		...
		public static float Gap
		{
			get
			{
				return ListingStandardUtil.gap;
			}
			set
			{
				ListingStandardUtil.gap = value;
			}
		}
		...
		public static float LineGap
		{
			get
			{
				return ListingStandardUtil.lineGap;
			}
			set
			{
				ListingStandardUtil.lineGap = value;
			}
		}
		...
		{
			listing_Standard.Gap(gap ?? ListingStandardUtil.lineGap);
			listing_Standard.GapLine(gap ?? ListingStandardUtil.lineGap);
		}

		public static void AddLabelLine(this Listing_Standard listing_Standard, string label, float? height = null)
		{
			listing_Standard.Gap(ListingStandardUtil.Gap);
		...
		public static void AddLabeledRadioList(this Listing_Standard listing_Standard, string header, string[] labels, ref string val, float? headerHeight = null)
		{
			...
			listing_Standard.AddRadioList(ListingStandardUtil.GenerateLabeledRadioValues(labels), ref val, null);
		}
		...
		public static void AddLabeledRadioList<T>(this Listing_Standard listing_Standard, string header, Dictionary<string, T> dict, ref T val, float? headerHeight = null)
		{
			listing_Standard.Gap(ListingStandardUtil.Gap);
			listing_Standard.AddLabelLine(header, headerHeight);
			listing_Standard.AddRadioList(ListingStandardUtil.GenerateLabeledRadioValues<T>(dict), ref val, null);
		}

		private static void AddRadioList<T>(this Listing_Standard listing_Standard, List<ListingStandardUtil.LabeledRadioValue<T>> items, ref T val, float? height = null)
		{
			foreach (ListingStandardUtil.LabeledRadioValue<T> labeledRadioValue in items)
			{
				listing_Standard.Gap(ListingStandardUtil.Gap);
		...
		private static List<ListingStandardUtil.LabeledRadioValue<string>> GenerateLabeledRadioValues(string[] labels)
		{
			List<ListingStandardUtil.LabeledRadioValue<string>> list = new List<ListingStandardUtil.LabeledRadioValue<string>>();
			foreach (string text in labels)
			{
				list.Add(new ListingStandardUtil.LabeledRadioValue<string>(text, text));
			}
			return list;
		}

		private static List<ListingStandardUtil.LabeledRadioValue<T>> GenerateLabeledRadioValues<T>(Dictionary<string, T> dict)
		{
			List<ListingStandardUtil.LabeledRadioValue<T>> list = new List<ListingStandardUtil.LabeledRadioValue<T>>();
			foreach (KeyValuePair<string, T> keyValuePair in dict)
			{
				list.Add(new ListingStandardUtil.LabeledRadioValue<T>(keyValuePair.Key, keyValuePair.Value));
			}
			return list;
		}
